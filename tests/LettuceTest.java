...
/**
 * Test class to verify the commands in the Lettuce migration guide.
 * This test validates that the Valkey Glide commands work as expected
 * compared to their Lettuce counterparts.
 */
public class LettuceTest {
    ...
    public void testHashOperations() throws ExecutionException, InterruptedException {
        ...
        map.put("key1", "1");
        map.put("key2", "2");
        Long added = client.hset("hash", map).get();
        ...
        Long deleted = client.hdel("hash3", new String[]{"key1", "key2"}).get();
        assertEquals(Long.valueOf(2), deleted);
