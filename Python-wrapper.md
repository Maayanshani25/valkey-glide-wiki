...
Valkey GLIDE provides support for both [Cluster](https://github.com/aws/glide-for-redis/wiki/Python-wrapper#cluster) and [Standalone](https://github.com/aws/glide-for-redis/wiki/Python-wrapper#redis-standalone) configurations. Please refer to the relevant section based on your specific setup.
